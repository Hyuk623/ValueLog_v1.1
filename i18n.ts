...
export const translations = {
  en: {
    app_name: "ValueLog",
    login_title: "Welcome to ValueLog",
    login_subtitle: "Your Lifetime Experience Portfolio",
    login_placeholder: "Enter your name or ID",
    login_button: "Start Journey",
    logout: "Logout",
    tab_stats: "Stats",
  ...
  ko: {
    app_name: "ValueLog",
    login_title: "ValueLog에 오신 것을 환영합니다",
    login_subtitle: "당신만을 위한 평생 경험 포트폴리오",
    login_placeholder: "이름 또는 아이디를 입력하세요",
    login_button: "시작하기",
    logout: "로그아웃",
    tab_stats: "통계",
    tab_timeline: "타임라인",
  ...
  ja: {
    app_name: "ValueLog",
    login_title: "ValueLogへようこそ",
    login_subtitle: "あなただけの生涯経験ポートフォリオ",
    login_placeholder: "名前またはIDを入力してください",
    login_button: "開始する",
    logout: "ログアウト",
    tab_stats: "統計",
    tab_timeline: "タイムライン",
  ...
  es: {
    app_name: "ValueLog",
    login_title: "Bienvenido a ValueLog",
    login_subtitle: "Tu Portafolio de Experiencias de Vida",
    login_placeholder: "Ingresa tu nombre o ID",
    login_button: "Comenzar",
